...
/** @type {<T>(array: ReadonlyArray<T>, index: number, data: T) => Array<T>} */
const setAt = (array, index, data) => withCopy(array, copy => { copy[index] = data })
...
module.exports = { withCopy, setAt, map, mapC, mapCR, filter, filterC, filterCR, separate, separateC, separateCR, first, zip, zipC, zipCR }
