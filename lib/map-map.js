...
module.exports = { clone, has, hasC, hasCR, get, getC, getCR, keys, keysC, keysCR, values, valuesC, valuesCR, entries, entriesC, entriesCR, set, setC, setCR, setU, setUC, setUCR, update, updateC, updateCR, remove, removeC, removeCR, mapValues, mapValuesC, mapValuesCR, valuesDisjoint }
