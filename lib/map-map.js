...
const insert = (map, key1, key2, value) => {
...
const insertC = (key1, key2, value) => map => insert(map, key1, key2, value)

/** @type {<K1, K2, V>(map: Map<K1, Map<K2, V>>) => (key1: K1, key2: K2, value: V) => boolean} */
const insertCR = map => (key1, key2, value) => insert(map, key1, key2, value)
...
module.exports = { clone, has, hasC, hasCR, get, getC, getCR, getUnsafe, getUnsafeC, getUnsafeCR, keys, keysC, keysCR, values, valuesC, valuesCR, entries, entriesC, entriesCR, insert, insertC, insertCR, update, updateC, updateCR, upsert, upsertC, upsertCR, remove, removeC, removeCR, mapValues, mapValuesC, mapValuesCR, valuesDisjoint }
