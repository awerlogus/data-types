...
/** @type {<P, R>(func: F.Arrow<P, R>) => (option: Option<P>) => Option<R>} */
...
/** @type {<P, R>(func: F.Arrow<P, Option<R>>) => (option: Option<P>) => Option<R>} */
...
/** @type {<P, R, N>(onSome: F.Arrow<P, R>, onNone: N) => (option: Option<P>) => R | N} */
const foldC = (onSome, onNone) => option => fold(option, onSome, onNone)

/** @type {<P, R, N>(onSome: F.Arrow<P, R>, onNone: F.Lazy<N>) => (option: Option<P>) => R | N} */
