...
/** @type {<T>(option: Option<T>) => Array<T>} */
const toArray = option => isSome(option) ? [option] : []

// SECTION Exports

module.exports = { none, isNone, isSome, map, mapC, mapCR, chain, chainC, chainCR, getOrElse, getOrElseL, getOrElseC, getOrElseLC, getOrElseCR, getOrElseLCR, fold, foldL, foldC, foldLC, foldCR, foldLCR, toArray }
