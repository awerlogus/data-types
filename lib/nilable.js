...
/** @type {<P, R>(func: F.Arrow<P, R>) => (nilable: Nilable<P>) => Nilable<R>} */
...
/** @type {<P, R>(func: F.Arrow<P, Nilable<R>>) => (nilable: Nilable<P>) => Nilable<R>} */
...
/** @type {<P, R, N>(onSome: F.Arrow<P, R>, onNil: N) => (nilable: Nilable<P>) => R | N} */
const foldC = (onSome, onNil) => nilable => fold(nilable, onSome, onNil)

/** @type {<P, R, N>(onSome: F.Arrow<P, R>, onNil: F.Lazy<N>) => (nilable: Nilable<P>) => R | N} */
