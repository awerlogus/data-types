...
/** @template E @typedef {readonly [false, E]} Left */

/** @template T @typedef {readonly [true, T]} Right */
...
/** @type {<E, T>(either: Either<E, T>) => <R>(func: Arrow<T, R>) => Either<E, R>} */
const mapCR = either => func => map(either, func)
...
/** @type {<E1, T>(either: Either<E1, T>) => <E2>(func: Arrow<E1, E2>) => Either<E2, T>} */
const mapLeftCR = either => func => mapLeft(either, func)
...
/** @type {<T, E1>(either: Either<E1, T>) => <E2, R>(func: Arrow<T, Either<E2, R>>) => Either<E1 | E2, R>} */
const chainCR = either => func => chain(either, func)
...
module.exports = { left, right, isLeft, isRight, map, mapC, mapCR, mapLeft, mapLeftC, mapLeftCR, chain, chainC, chainCR, get, extractUnsafe }
