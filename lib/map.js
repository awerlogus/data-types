...
module.exports = { clone, has, hasC, hasCR, get, getC, getCR, getUnsafe, getUnsafeC, getUnsafeCR, keys, values, entries, set, setC, setCR, setU, setUC, setUCR, update, updateC, updateCR, upsert, upsertC, upsertCR, remove, removeC, removeCR, mapValues, mapValuesC, mapValuesCR, valuesDisjoint }
