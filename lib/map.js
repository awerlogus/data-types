...
module.exports = { clone, has, hasC, hasCR, get, getC, getCR, keys, values, entries, set, setC, setCR, setU, setUC, setUCR, remove, removeC, removeCR, mapValues, mapValuesC, mapValuesCR, valuesDisjoint }
