...
module.exports = { clone, has, hasC, hasCR, get, getC, getCR, keys, values, entries, set, setC, setCR, setU, setUC, setUCR, update, updateC, updateCR, remove, removeC, removeCR, mapValues, mapValuesC, mapValuesCR, valuesDisjoint }
