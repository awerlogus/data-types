...
describe('mapCR function', () => {
  it('should return Nil if Nil value passed', () => {
    expect(NO.mapCR(/** @type {O.Option<number>} */(O.none))(add1)).toBe(O.none)
    expect(NO.mapCR(/** @type {Nullable<number>} */(null))(add1)).toBeNull()
  })

  it('should apply function if Some data passed', () => {
    expect(NO.mapCR(0)(add1)).toBe(1)
    expect(NO.mapCR(0)(add1)).toBe(1)
  })
})
...
describe('chainCR function', () => {
  it('should return Nil if Nil value passed', () => {
    expect(NO.chainCR(/** @type {O.Option<number>} */(O.none))(checkNonZeroO)).toBe(O.none)
    expect(NO.chainCR(/** @type {Nullable<number>} */(null))(checkNonZeroN)).toBeNull()
  })

  it('should return Nil if function returned Nil', () => {
    expect(NO.chainCR(0)(checkNonZeroO)).toBe(O.none)
    expect(NO.chainCR(0)(checkNonZeroN)).toBeNull()
  })

  it('should return Some data if function returned Some', () => {
    expect(NO.chainCR(1)(checkNonZeroO)).toBe(1)
    expect(NO.chainCR(1)(checkNonZeroN)).toBe(1)
  })
})
...
describe('getOrElseCR function', () => {
  it('should return initial Some data', () => {
    expect(NO.getOrElseCR(1)(0)).toBe(1)
    expect(NO.getOrElseCR(1)(0)).toBe(1)
  })

  it('should return alter data if Nil passed', () => {
    expect(NO.getOrElseCR(O.none)(0)).toBe(0)
    expect(NO.getOrElseCR(null)(0)).toBe(0)
  })
})

describe('getOrElseLCR function', () => {
  it('should return initial Some data', () => {
    expect(NO.getOrElseLCR(1)(getZero)).toBe(1)
    expect(NO.getOrElseLCR(1)(getZero)).toBe(1)
  })

  it('should return alter data if Nil passed', () => {
    expect(NO.getOrElseLCR(O.none)(getZero)).toBe(0)
    expect(NO.getOrElseLCR(null)(getZero)).toBe(0)
  })
})
...
describe('foldCR function', () => {
  it('should map value with first function on data is Some', () => {
    expect(NO.foldCR(0)(add1, 0)).toBe(1)
    expect(NO.foldCR(0)(add1, 0)).toBe(1)
  })

  it('should return default value on data is Nil', () => {
    expect(NO.foldCR(/** @type {O.Option<number>} */(O.none))(add1, 0)).toBe(0)
    expect(NO.foldCR(/** @type {Nullable<number>} */(null))(add1, 0)).toBe(0)
  })
})

describe('foldLCR function', () => {
  it('should map value with first function on data is Some', () => {
    expect(NO.foldLCR(0)(add1, getZero)).toBe(1)
    expect(NO.foldLCR(0)(add1, getZero)).toBe(1)
  })

  it('should return default value on data is Nil', () => {
    expect(NO.foldLCR(/** @type {O.Option<number>} */(O.none))(add1, getZero)).toBe(0)
    expect(NO.foldLCR(/** @type {Nullable<number>} */(null))(add1, getZero)).toBe(0)
  })
})
