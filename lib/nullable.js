...
/** @type {<P, R>(func: F.Arrow<P, R>) => F.Arrow<Nullable<P>, Nullable<R>>} */
...
/** @type {<P, R>(func: F.Arrow<P, Nullable<R>>) => F.Arrow<Nullable<P>, Nullable<R>>} */
...
/** @type {<P, R, N>(onSome: F.Arrow<P, R>, onNull: N) => F.Arrow<Nullable<P>, R | N>} */
const foldC = (onSome, onNull) => nullable => fold(nullable, onSome, onNull)

/** @type {<P, R, N>(onSome: F.Arrow<P, R>, onNull: F.Lazy<N>) => F.Arrow<Nullable<P>, R | N>} */
