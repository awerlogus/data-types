...
describe('toArray function', () => {
  it('should return an empty array for None', () => {
    expect(O.toArray(O.none)).toStrictEqual([])
  })

  it('should wrap value in array for Some', () => {
    expect(O.toArray(false)).toStrictEqual([false])
    expect(O.toArray(true)).toStrictEqual([true])
    expect(O.toArray('')).toStrictEqual([''])
    expect(O.toArray(0)).toStrictEqual([0])
    expect(O.toArray(1)).toStrictEqual([1])
  })
})
