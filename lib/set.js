...
/** @type {<T>(set1: ReadonlySet<T>, set2: ReadonlySet<T>) => boolean} */
const intersects = (set1, set2) => nonEmpty(set1) && nonEmpty(set2) && some(set1, set2.has.bind(set2))
...
module.exports = { clone, has, hasC, hasCR, add, addC, addCR, remove, removeC, removeCR, union, unionC, separate, separateC, some, someC, none, noneC, every, everyC, map, mapC, chain, chainC, filter, filterC, equal, equalC, empty, nonEmpty, intersects, intersectsC }
