...
/** @type {<I, O>(func: F.Arrow<I, O>) => (set: ReadonlySet<I>) => Set<O>} */
const mapC = func => set => map(set, func)

/** @type {<I, O>(set: ReadonlySet<I>, func: F.Arrow<I, ReadonlySet<O>>) => Set<O>} */
const chain = (set, func) => I.reduce(set, (s1, s2) => union(s1, func(s2)), new Set())

/** @type {<I, O>(func: F.Arrow<I, ReadonlySet<O>>) => (set: ReadonlySet<I>) => Set<O>} */
