...
describe('concat function', () => {
  it('should return empty iterable if both iterables are empty', () => {
    ...
    expect(Array.from(I.concat(data1, data2))).toStrictEqual([])
  })
  ...
  it('should return iterable with first iterable content if the second is empty', () => {
    ...
    expect(Array.from(I.concat(data1, data2))).toStrictEqual([1, 2])
  })
  ...
  it('should return iterable with second iterable content if the first is empty', () => {
    ...
    expect(Array.from(I.concat(data1, data2))).toStrictEqual([3, 4])
  })
  ...
  it('should return iterable contains elements of both iterables', () => {
    ...
    expect(Array.from(I.concat(data1, data2))).toStrictEqual([1, 2, 3, 4])
  })
})

describe('concatC function', () => {
  it('should return empty iterable if both iterables are empty', () => {
    /** @type {ReadonlySet<number>} */
    const data1 = new Set()
    /** @type {ReadonlySet<number>} */
    ...
    expect(Array.from(I.concatC(data1)(data2))).toStrictEqual([])
  })
  ...
  it('should return iterable with first iterable content if the second is empty', () => {
    ...
    expect(Array.from(I.concatC(data1)(data2))).toStrictEqual([1, 2])
  })
  ...
  it('should return iterable with second iterable content if the first is empty', () => {
    ...
    expect(Array.from(I.concatC(data1)(data2))).toStrictEqual([3, 4])
  })
  ...
  it('should return iterable contains elements of both iterables', () => {
    ...
    expect(Array.from(I.concatC(data1)(data2))).toStrictEqual([1, 2, 3, 4])
  })
})

describe('concatCR function', () => {
  it('should return empty iterable if both iterables are empty', () => {
    /** @type {ReadonlySet<number>} */
    const data1 = new Set()
    /** @type {ReadonlySet<number>} */
    ...
    expect(Array.from(I.concatCR(data2)(data1))).toStrictEqual([])
  })
  ...
  it('should return iterable with first iterable content if the second is empty', () => {
    ...
    expect(Array.from(I.concatCR(data2)(data1))).toStrictEqual([1, 2])
  })
  ...
  it('should return iterable with second iterable content if the first is empty', () => {
    ...
    expect(Array.from(I.concatCR(data2)(data1))).toStrictEqual([3, 4])
  })
  ...
  it('should return iterable contains elements of both iterables', () => {
    ...
    expect(Array.from(I.concatCR(data2)(data1))).toStrictEqual([1, 2, 3, 4])
  })
})
