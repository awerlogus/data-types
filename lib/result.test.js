const NL = require('./nullable')
const N = require('./nilable')
...
describe('map function', () => {
  it('should return Err if Err value passed', () => {
    expect(R.map(R.err, add1)).toMatchObject(R.err)
  })

  it('should apply function if Ok data passed', () => {
    expect(R.map(R.ok(0), add1)).toMatchObject(R.ok(1))
  })
})

describe('mapC function', () => {
  it('should return Err if Err value passed', () => {
    expect(R.mapC(add1)(R.err)).toMatchObject(R.err)
  })

  it('should apply function if Ok data passed', () => {
    expect(R.mapC(add1)(R.ok(0))).toMatchObject(R.ok(1))
  })
})

describe('chain function', () => {
  it('should return Err if Err value passed', () => {
    expect(R.chain(R.err, checkNonZero)).toMatchObject(R.err)
  })

  it('should return Err if function returned Err', () => {
    expect(R.chain(R.ok(0), checkNonZero)).toMatchObject(R.err)
  })

  it('should return Ok data if function returned Ok', () => {
    expect(R.chain(R.ok(1), checkNonZero)).toMatchObject(R.ok(1))
  })
})

describe('chainC function', () => {
  it('should return Err if Err value passed', () => {
    expect(R.chainC(checkNonZero)(R.err)).toMatchObject(R.err)
  })

  it('should return Err if function returned Err', () => {
    expect(R.chainC(checkNonZero)(R.ok(0))).toMatchObject(R.err)
  })

  it('should return Ok data if function returned Ok', () => {
    expect(R.chainC(checkNonZero)(R.ok(1))).toMatchObject(R.ok(1))
  })
})
...
describe('fromNullable function', () => {
  it('should return Err if Null passed', () => {
    expect(R.fromNullable(null)).toMatchObject(R.err)
  })

  it('should return Ok data if Some data passed', () => {
    expect(R.fromNullable(N.some(0))).toMatchObject(R.ok(0))
  })
})

describe('fromNilable function', () => {
  it('should return Err if Nil passed', () => {
    expect(R.fromNilable(O.none)).toMatchObject(R.err)
    expect(R.fromNilable(null)).toMatchObject(R.err)
  })

  it('should return Ok data if Some data passed', () => {
    expect(R.fromNilable(NL.some(0))).toMatchObject(R.ok(0))
  })
})
