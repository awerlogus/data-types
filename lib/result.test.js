...
describe('fromOption function', () => {
  ...
  it('should return Ok data if Some data passed', () => {
    expect(R.fromOption(O.some(0))).toStrictEqual(R.ok(0))
  })
})
...
describe('fromNullable function', () => {
  ...
  it('should return Ok data if Some data passed', () => {
    expect(R.fromNullable(N.some(0))).toStrictEqual(R.ok(0))
  })
})
...
describe('fromNilable function', () => {
  ...
  it('should return Ok data if Some data passed', () => {
    expect(R.fromNilable(NO.some(0))).toStrictEqual(R.ok(0))
  })
})
