...
describe('mapCR function', () => {
  it('should return Err if Err value passed', () => {
    expect(R.mapCR(R.err)(add1)).toStrictEqual(R.err)
  })

  it('should apply function if Ok data passed', () => {
    expect(R.mapCR(R.ok(0))(add1)).toStrictEqual(R.ok(1))
  })
})
...
describe('chainCR function', () => {
  it('should return Err if Err value passed', () => {
    expect(R.chainCR(R.err)(checkNonZero)).toStrictEqual(R.err)
  })

  it('should return Err if function returned Err', () => {
    expect(R.chainCR(R.ok(0))(checkNonZero)).toStrictEqual(R.err)
  })

  it('should return Ok data if function returned Ok', () => {
    expect(R.chainCR(R.ok(1))(checkNonZero)).toStrictEqual(R.ok(1))
  })
})
...
describe('getOrElseCR function', () => {
  it('should return initial Ok data', () => {
    expect(R.getOrElseCR(R.ok(1))(0)).toBe(1)
  })

  it('should return alter data if Err passed', () => {
    expect(R.getOrElseCR(R.err)(0)).toBe(0)
  })
})

describe('getOrElseLCR function', () => {
  it('should return initial Ok data', () => {
    expect(R.getOrElseLCR(R.ok(1))(getZero)).toBe(1)
  })

  it('should return alter data if Err passed', () => {
    expect(R.getOrElseLCR(R.err)(getZero)).toBe(0)
  })
})
