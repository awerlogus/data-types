...
describe('get function', () => {
  it('should return set if it exists', () => {
    expect(MS.get(new Map([[1, new Set([1, 2])]]), 1)).toMatchObject(new Set([1, 2]))
  })

  it('should return an empty set if set doesn\'t exist', () => {
    expect(MS.get(new Map([[1, new Set([1, 2])]]), 2)).toMatchObject(new Set())
  })
})

describe('getC function', () => {
  it('should return set if it exists', () => {
    expect(MS.getC(1)(new Map([[1, new Set([1, 2])]]))).toMatchObject(new Set([1, 2]))
  })

  it('should return an empty set if set doesn\'t exist', () => {
    expect(MS.getC(2)(new Map([[1, new Set([1, 2])]]))).toMatchObject(new Set())
  })
})

describe('getCR function', () => {
  it('should return set if it exists', () => {
    expect(MS.getCR(new Map([[1, new Set([1, 2])]]))(1)).toMatchObject(new Set([1, 2]))
  })

  it('should return an empty set if set doesn\'t exist', () => {
    expect(MS.getCR(new Map([[1, new Set([1, 2])]]))(2)).toMatchObject(new Set())
  })
})
...
describe('add function', () => {
  it('should return true if set didn\'t exist', () => {
    ...
    expect(mapSet).toMatchObject(new Map([[1, new Set([2])]]))
  })
  ...
  it('should return true if set exists but item didn\'t exist', () => {
    ...
    expect(MS.add(mapSet, 1, 2)).toBe(true)
    expect(mapSet).toMatchObject(new Map([[1, new Set([1, 2])]]))
  })
...
describe('remove function', () => {
  it('should return false if set didn\'t exist', () => {
    ...
    expect(mapSet).toMatchObject(new Map())
  })

  it('should return false if item set didn\'t exist', () => {
    const mapSet = new Map([[1, new Set([1])]])

    expect(MS.remove(mapSet, 1, 2)).toBe(false)

    expect(mapSet).toMatchObject(new Map([[1, new Set([1])]]))
  })

  it('should return false if item set existed', () => {
    const mapSet = new Map([[1, new Set([1, 2])]])
