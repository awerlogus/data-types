...
describe('flow function', () => {
  it('should return function that applies second function to result of first', () => {
    ...
    expect(F.flow(F.flow(double, increment), double)(1)).toBe(6)
  })
})
...
describe('flowC function', () => {
  it('should return function that applies second function to result of first', () => {
    ...
    expect(F.flowC(F.flowC(double)(increment))(double)(1)).toBe(6)
  })
})

describe('flowCR function', () => {
  it('should return function that applies second function to result of first', () => {
    expect(F.flowCR(increment)(double)(1)).toBe(3)
    expect(F.flowCR(double)(increment)(1)).toBe(4)
    expect(F.flowCR(double)(double)(1)).toBe(4)
    expect(F.flowCR(increment)(increment)(1)).toBe(3)
    expect(F.flowCR(double)(F.flowCR(increment)(double))(1)).toBe(6)
  })
})
